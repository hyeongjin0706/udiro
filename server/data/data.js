    ...
    place.forEach(e => {
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                const weather = items.getElementsByTagName("WEATHER_STTS");
                const road = items.getElementsByTagName("ROAD_TRAFFIC_STTS");
                ...
                Data.create({
                    ...
                    .then((result) => {
                        console.log('Data 모델에 데이터 생성 성공:', result.dataValues);
                    })
                    .catch((error) => {
                        console.error('Data 모델에 데이터 생성 중 에러 발생:', error);
                    });
            })
            .catch((error) => {
...
setInterval(dataSave, 600000)




export async function getAll() {
    return Data.findAll({ ...ORDER_DESC });
}
